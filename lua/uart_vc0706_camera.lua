...
local cam_baud = tonumber(_G.UART_CAM_BAUD) or tonumber(_G.VC0706_BAUD) or 9600
local cam_action = tostring(_G.UART_CAM_ACTION or _G.VC0706_ACTION or "capture")
local cam_output = tostring(_G.UART_CAM_OUTPUT or _G.VC0706_OUTPUT or "capture.jpg")
local cam_reset = (_G.UART_CAM_RESET == true) or (_G.VC0706_RESET == true)
local cam_quiet = (_G.UART_CAM_QUIET == true) or (_G.VC0706_QUIET == true)
...
local function run_action()
  ...
  camera_log("UART connected, waiting 2.0s for camera stabilization")
  util_sleep(2.0)
